...
import {
  ...
  Clock, Calendar, ChevronRight, Plus, ArrowUpRight,
                ...
                <ScrollArea className="h-[380px]">
                  <div className="space-y-1">
                    {activities.map((activity, i) => {
                      ...
                      return (
                        <div key={activity.id} className="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50 cursor-pointer group transition-colors">
