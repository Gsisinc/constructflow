...
import { Building2, CheckCircle2, Users, Calendar, FileText, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <Button onClick={handleLogin} className="bg-slate-900 hover:bg-slate-800">
            Sign In
          </Button>
        </div>
      </header>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-600 mb-8">
            All-in-one platform for contractors to manage projects, teams, and finances
          </p>
          <div className="flex gap-4 justify-center">
            <Button onClick={handleLogin} size="lg" className="bg-slate-900 hover:bg-slate-800 text-lg px-8">
              Get Started Free
            </Button>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            ...
            <p className="text-slate-600">Track crew hours, weather, and daily activities in real-time</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border">
            ...
            <p className="text-slate-600">Create professional estimates and track opportunities</p>
          </div>
      ...
      <section className="bg-slate-900 py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <Button onClick={handleLogin} size="lg" variant="secondary" className="text-lg px-8">
