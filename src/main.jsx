...
if (!root) {
  document.body.innerHTML = '<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:#102a43;color:#fbbf24;font-family:system-ui,sans-serif;padding:1rem;text-align:center;"><p>App root (#root) not found.</p></div>'
} else {
  try {
    ...
    root.innerHTML = `<div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#102a43;color:#fbbf24;font-family:system-ui,sans-serif;padding:1rem;text-align:center;">
      ...
      <pre style="background:#1e293b;padding:1rem;border-radius:8px;font-size:0.75rem;overflow:auto;max-width:90%;">${(err && err.message) || String(err)}</pre>
    </div>`
  }
}
